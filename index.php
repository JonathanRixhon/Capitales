<?php
require "./validaton.php";
$countries = require './data/config.php';
...
<body>
    <main class="container">
        ...
        <?php elseif (count($data)) : ?>
            <section class="media">
                <img src="img/<?= $data[$requestedCountryName]['flag-file'] ?>" class="mr-3" alt="Drapeau de <?= ucwords($requestedCountryName) ?>">
